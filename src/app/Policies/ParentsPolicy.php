...
class ParentsPolicy
{
    ...
    {
        return $user->can('view_any_parents');
    }
    ...
    {
        return $user->can('create_parents');
    }
    ...
    {
        return $user->can('update_parents');
    }
    ...
    {
        return $user->can('delete_parents');
    }
    ...
    {
        return $user->can('delete_any_parents');
    }
